...
ifeq ($(TARGET_USE_DYNAMIC_PARTITIONS),true)
  ifeq ($(IMX_NO_PRODUCT_PARTITION),true)
    ...
    ifeq ($(IMX8MQ_USES_GKI),true)
      ...
      # TARGET_BOARD_DTS_CONFIG ?= imx8mq:em-sbc-imx8m-android-hdmi.dtb
      # @echo "I am in IMX8MQ_USES_GKI"
      # test:
      #   CURRENTDIR =  $(shell pwd)
      #   $(info  Iam in IMX8MQ_USES_GKI $(value CURRENTDIR))
      TARGET_BOARD_DTS_CONFIG ?= imx8mq:maaxboard/android-hdmi.dtbo
      ...
      # @echo "I am not in IMX8MQ_USES_GKI else"
      $(info  I am not in IMX8MQ_USES_GKI else)
      # imx8mq with HDMI display
      TARGET_BOARD_DTS_CONFIG ?= imx8mq:maaxboard-android-hdmi.dtb
